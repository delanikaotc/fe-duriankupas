    ...
    <div class="sub-content row d-flex justify-content-center">
        ...
        <div class="card-produk">
            ...
            <div class="card-produk title">
                <input name="product" style="text-align: center;" type="text" readonly class="form-control-plaintext" id="staticEmail" value="{{ $item['nama'] }}"> 
            </div>
            ...
            {!! method_field('post') . csrf_field() !!}
                <div class="row d-flex justify-content-center">
                    <div class="input-group mb-3" style="width: 150px">
                        ...
                        <input name="jumlah" type="text" class="form-control" placeholder="" aria-label="Example text with button addon" aria-describedby="button-addon1" style="text-align: center;">
                        <button class="btn btn-outline-secondary" type="button" id="button-addon1">+</button>
                      </div>
                </div>
        </div> 
